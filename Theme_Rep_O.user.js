...
// @noframes
// @grant        none
// @updateURL        https://github.com/personwritep/Theme_Rep_O/raw/main/Theme_Rep_O.user.js
...
function main(){
    if(document.querySelector('.skinBody')){ // 旧スキンブログ画面で動作
        ...
        if(help_TR){
            let url='https://ameblo.jp/personwritep/entry-12797550759.html';
